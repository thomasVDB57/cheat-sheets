...
* Adjust your keyboard layout if it's in the wrong mode **localectl set-keymap be**
...
- Use the command `ip link` or `ip a`
...
- What port is the service using? `sudo ss -tlnp` (list TCP (`-t`) server (`-l`) port numbers (`-n`) with the process behind them (`-p`). The `-p` option requires root, hence the `sudo`)
    ...
    - If you change the port that the service listens to don't forget to restart the service `sudo systemctl restart httpd.service` (reminder)
...
# Other troubleshooting resources and links to guides

- rhel 7 sysadmin guide: [https://access.redhat.com/documentation/en-US/Red_Hat_Enterprise_Linux/7/html/System_Administrators_Guide/](https://access.redhat.com/documentation/en-US/Red_Hat_Enterprise_Linux/7/html/System_Administrators_Guide/ "Basic sysadmin guide")
- Rhel 7 firewall guide: [https://access.redhat.com/documentation/en-US/Red_Hat_Enterprise_Linux/7/html/Security_Guide/sec-Using_Firewalls.html](https://access.redhat.com/documentation/en-US/Red_Hat_Enterprise_Linux/7/html/Security_Guide/sec-Using_Firewalls.html "Using Firewalls")
- Rhel 7 networking guide [https://access.redhat.com/documentation/en-US/Red_Hat_Enterprise_Linux/7/html/Networking_Guide/](https://access.redhat.com/documentation/en-US/Red_Hat_Enterprise_Linux/7/html/Networking_Guide/ "networking guide rhel 7")
